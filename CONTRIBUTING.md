# 參與 mhat-cognitive-service-face-api
...
如果您在這個專案裡面找到任何bug或者想要針對任意地方提出建議/意見，歡迎透過[開issue](https://github.com/alantsai/mhat-cognitive-service-face-api/issues/new) 或者 可以在 [gitter](https://gitter.im/alantsai/mhat-cognitive-service-face-api?utm_source=share-link&utm_medium=link&utm_campaign=share-link)上面發問。
